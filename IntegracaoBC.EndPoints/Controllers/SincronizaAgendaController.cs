...
namespace IntegracaoBC.EndPoints.Controllers
{
    ...
    [ApiController]
    public class SincronizaAgendaController : BaseController
    {
        private readonly ISincronizaAgendaService _iService;
        public SincronizaAgendaController(ISincronizaAgendaService iService, IConfiguration iConfiguration) : base(iConfiguration)
        {
            _iService = iService;
        }
