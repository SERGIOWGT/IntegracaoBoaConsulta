...
namespace IntegracaoBC.EndPoints.Controllers
{
    ...
    [ApiController]
    public class SincronizaConsultoriosController : BaseController
    {
        private readonly ISincronizaConsultoriosService _iService;
        public SincronizaConsultoriosController(ISincronizaConsultoriosService iService, IConfiguration iConfiguration) : base(iConfiguration)
        {
            _iService = iService;
        }
